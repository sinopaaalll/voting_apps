...
<div class="page-header">
    <div><span class="eyebrow">Peserta pemilihan</span><h1>Kandidat</h1><p>Kelola data kandidat dan perolehan suaranya.</p></div>
    ...
    @forelse ($kandidat as $item)
        <article class="admin-candidate-card">
            ...
            <div class="candidate-actions">
                <a class="btn btn-small btn-ghost" href="{{ route('admin.kandidat.edit', $item) }}">Edit</a>
